...
uses
    ...
    TeeProcs, Chart, FaGraphEx, AntiPinchTestFrame;

type
    TfrmAntiPinch = class(TfrmBaseMain)
        pnlClient: TPanel;
        shpTop: TShape;
        shpLeft: TShape;
        shpRight: TShape;
        ...
        tcCon: TTabControl;
    pnlAntipinch: TPanel;
    fmReclAP: TAntipinchTestFrme;
    fmSlideAP: TAntipinchTestFrme;
    pnlCenterSpace: TPanel;
...
procedure TfrmAntiPinch.chtMtrDblClick(Sender: TObject);
begin
...
procedure TfrmAntiPinch.DisplayDiskFree;
var
    dTm: double;
    iTm, Total: int64;
begin
...
procedure TfrmAntiPinch.FormClose(Sender: TObject; var Action: TCloseAction);
begin
    inherited;
    FreeAndNil(abPLC);
    FreeAndNil(gWork);
...
procedure TfrmAntiPinch.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
    inherited;
...
procedure TfrmAntiPinch.FormCreate(Sender: TObject);
begin
    inherited;
...
procedure TfrmAntiPinch.FormDestroy(Sender: TObject);
begin
...
procedure TfrmAntiPinch.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var
    i: Integer;
...
procedure TfrmAntiPinch.FormShow(Sender: TObject);
var
    i: Integer;
...
{$ENDIF}
    ...
    begin
        ...
        AddSubForm(TfrmAntiPinch.Create(Self)).ShowPLCInfo(False);
    end;
...
procedure TfrmAntiPinch.GlobalExceptionHandler(Sender: TObject; E: Exception);
begin
...
procedure TfrmAntiPinch.HandleReadMessage(var myMsg: TMessage);
begin
...
procedure TfrmAntiPinch.lblSimLanInModeClick(Sender: TObject);
begin
...
procedure TfrmAntiPinch.OnWorkStatus(AStatus: Integer);
...
procedure TfrmAntiPinch.ShowConnectorForm(Station: integer);
begin
...
procedure TfrmAntiPinch.SpeedButton1Click(Sender: TObject);
begin
    inherited;
    ShowMessage('TEST');
end;

procedure TfrmAntiPinch.sbtnConClick(Sender: TObject);
begin
    ShowConnectorForm(Ord(mTsWork.StationID));
end;

procedure TfrmAntiPinch.sbtnExitClick(Sender: TObject);
begin
...
procedure TfrmAntiPinch.sbtnModelClick(Sender: TObject);
begin
...
procedure TfrmAntiPinch.sbtnReferenceClick(Sender: TObject);
begin
    if not ShowPasswordForm then
        Exit;
    ...
    frmUserRefer := TfrmUserRefer.Create(Self, [uriPwrSpl, uriECU], [riMotor, riIMSLimit, riAntipinch]);
    frmUserRefer.FormStyle := fsStayOnTop;
    frmUserRefer.Show();

end;

procedure TfrmAntiPinch.sbtnRetrieveClick(Sender: TObject);
var
    sTm: string;
    nP: IProcesses;
    nF: TfrmWait;
...
procedure TfrmAntiPinch.SetBurnishingCount(Motor: TSeatMotor);
begin
    case Motor.ID of
        tmSlide:
            begin
...
procedure TfrmAntiPinch.sgConDrawCell(Sender: TObject; ACol, ARow: Integer; Rect: TRect; State: TGridDrawState);
var
...
procedure TfrmAntiPinch.tcConChange(Sender: TObject);
begin
    if tcCon.TabIndex = 0 then
        UpdateConUI(mTsWork.MainCon);
end;

procedure TfrmAntiPinch.tmrDiskChkTimer(Sender: TObject);
begin
    inherited;
    DisplayDiskFree;
end;

procedure TfrmAntiPinch.tmrMainTimer(Sender: TObject);
var
    dTm: double;
    sTm: string;
begin
...
procedure TfrmAntiPinch.tmrPollTimer(Sender: TObject);
begin
...
procedure TfrmAntiPinch.tmrShowTimer(Sender: TObject);
begin
    inherited;
...
procedure TfrmAntiPinch.UpdateConUI(Con: TBaseSeatConnector);
var
...
procedure TfrmAntiPinch.WorkClose(Sender: TObject);
begin
    gWork.Thread := nil;
    Close;
end;

procedure TfrmAntiPinch.WorkError(Sender: TObject);
begin
    gWork.Thread := nil;
...
procedure TfrmAntiPinch.ReadCount;
var
    nOK, nNG: Integer;
begin
...
procedure TfrmAntiPinch.ReadDAQValues;
var
...
procedure TfrmAntiPinch.ReadWorkCycleTime;
const
