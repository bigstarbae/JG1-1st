inherited frmAntiPinch: TfrmAntiPinch
  Top = 60
  BorderStyle = bsNone
  Caption = 'AntiPinchTester'
  ClientHeight = 1080
  ClientWidth = 1920
  HelpFile = '1080'
  Position = poDesigned
  ...
  object pnlClient: TPanel [7]
    ...
    object pnlAntipinch: TPanel
      ...
      BevelOuter = bvNone
      TabOrder = 0
      inline fmReclAP: TAntipinchTestFrme
        Left = 0
        Top = 286
        Width = 1580
        Height = 250
      ...
      inline fmSlideAP: TAntipinchTestFrme
        Left = 0
        Top = 0
        Width = 1580
        Height = 250
