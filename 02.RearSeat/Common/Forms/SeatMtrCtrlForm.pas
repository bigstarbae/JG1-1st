...
begin
    ...
    mMtrJogUI[tmRecl].Find(Self, 'Recl');
//    mMtrJogUI[tmLSupt].Find(Self, 'LSupt');
//    mMtrJogUI[tmBolster].Find(Self, 'Bolster');
...
begin
//    mMtrJogUI[tmRecl].Update(mMotors[0]);
//    mMtrJogUI[tmLSupt].Update(mMotors[1]);
//    mMtrJogUI[tmBolster].Update(mMotors[2]);
