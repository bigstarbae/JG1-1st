...
type
    TfrmReferItem = (riOP, riComm, riMotor, riBurnishing, riSoundProof, riBackAngle, riElec, riBuckle, riIMSLimit, riIMSMem, riAntipinch, riMnlSlide, riMnlHeight);
    ...
    edtMtr_MinAmp: TEdit;
        ...
        Label110: TLabel;
        Label111: TLabel;
        edtSli_LvrEndForce: TEdit;
        edtSli_LvrMinForce: TEdit;
        edtSli_SliMinForce: TEdit;
        GroupBox10: TGroupBox;
        ckbSli_UseLvrSwZero: TCheckBox;
        ckbSli_UseSliSwZero: TCheckBox;
        ckbSli_UseLvrCollectPoint: TCheckBox;
        ckbSli_UseSliCollectPoint: TCheckBox;
        GroupBox12: TGroupBox;
        Label112: TLabel;
        Label115: TLabel;
        Label116: TLabel;
        edtSli_LvrFilter: TEdit;
        edtSli_SliFwFilter: TEdit;
        edtSli_SliBwFilter: TEdit;
        ckbSli_UseOverSendPLC: TCheckBox;
        grbSli_Limit: TGroupBox;
        Label118: TLabel;
        Label119: TLabel;
        Label120: TLabel;
        edtSli_LvrLimit: TEdit;
        edtSli_SliFwLimit: TEdit;
        edtSli_SliBwLimit: TEdit;
        ckbSli_IsMinLvrForceSendPLC: TCheckBox;
        pnlMnlHeight: TPanel;
        Shape33: TShape;
        Label124: TLabel;
        GroupBox16: TGroupBox;
        ckbPump_UseRealGraph: TCheckBox;
        ckbPump_UseAnalyGraph: TCheckBox;
        ckbPump_UseDiplayDatas: TCheckBox;
        ckbPump_UseCollectSection: TCheckBox;
        ckbPump_UseDisplayDelay: TCheckBox;
        ckbPump_UseOverSendPLC: TCheckBox;
        grbPump_Limit: TGroupBox;
        Label131: TLabel;
        Label134: TLabel;
        edtPump_LHLimit: TEdit;
        edtPump_RHLimit: TEdit;
        ckbPump_UseSwZero: TCheckBox;
        GroupBox18: TGroupBox;
        Label140: TLabel;
        Label141: TLabel;
        edtPump_LHFilter: TEdit;
        edtPump_RHFilter: TEdit;
        Panel36: TPanel;
        Shape35: TShape;
        Label142: TLabel;
        ...
        Label101: TLabel;
        Label102: TLabel;
        edtBk_StabliTime: TEdit;
        edtBk_MaxCollectData: TEdit;
        rdgBk_DataResultType: TRadioGroup;
        GroupBox8: TGroupBox;
        Label103: TLabel;
        Label104: TLabel;
        Label105: TLabel;
        Label106: TLabel;
        edtBk_ExDataStart: TEdit;
        edtBk_ExDataEnd: TEdit;
        Shape36: TShape;
        Label22: TLabel;
        Label98: TLabel;
        edtBk_DualMtrDevCurr: TEdit;
        pnlBuckle: TPanel;
        Shape37: TShape;
        Label63: TLabel;
        Label81: TLabel;
        ...
        Label27: TLabel;
        GroupBox7: TGroupBox;
        ckbBk_UseRearmost: TCheckBox;
        ckbBk_UseFolding: TCheckBox;
        GroupBox4: TGroupBox;
        ...
        ckbAP_UseSlide: TCheckBox;
        ckbAP_UseRecl: TCheckBox;
        GroupBox9: TGroupBox;
        cbxSli_UseLever: TCheckBox;
        cbxSli_UseSlide: TCheckBox;
        cbxSli_UseLocking: TCheckBox;
        ckbSli_ControlRetry: TCheckBox;
        edtSli_Retry: TEdit;
        Label117: TLabel;
        GroupBox14: TGroupBox;
        Label129: TLabel;
        Label130: TLabel;
        edtPump_CycleMinAngle: TEdit;
        edtPump_CycleUpAngle: TEdit;
        GroupBox15: TGroupBox;
        ckbPump_UseForce: TCheckBox;
        ckbPump_UseCount: TCheckBox;
        ckbPump_UseEndPoint: TCheckBox;
        ckbPump_UseAngle: TCheckBox;
        ckbPump_UseDeviceSleep: TCheckBox;
        ckbPump_UseUpHeight: TCheckBox;
        rdgPump_DataResult: TRadioGroup;
        rdgPump_TestOrd: TRadioGroup;
        ...
        procedure Label108DblClick(Sender: TObject);
    ...
    private
        ...
        procedure IsTabVisible(Tabsheet: TTabSheet; IsVisible: Boolean); overload;
        procedure SetItemVisible(Item: TfrmReferItem); overload;
        procedure IsAllTabVisible(IsVisible: Boolean);
...
procedure TfrmReference.IsTabVisible(Tabsheet: TTabSheet; IsVisible: Boolean);
begin
    Tabsheet.TabVisible := IsVisible;
    Tabsheet.Visible := IsVisible;
end;

procedure TfrmReference.Label108DblClick(Sender: TObject);
begin
    inherited;
    ckbSli_ControlRetry.Visible := not ckbSli_ControlRetry.Visible;
    Label117.Visible := not Label117.Visible;
    edtSli_Retry.Visible := not edtSli_Retry.Visible;
end;
...
begin
    ...
    IsTabVisible(tsOp, true);
    IsTabVisible(tsComm, true);
...
procedure TfrmReference.IsAllTabVisible(IsVisible: Boolean);
var
    i: Integer;
    Sheet: TTabSheet;
begin
...
begin
    case Item of
        riMotor:
            IsTabVisible(tsMtr, true);
        riBurnishing:
            begin
                pnlMtr_Align.Visible := True;
            end;
        riSoundProof:
            IsTabVisible(tsSP, true);
        riBackAngle:
            IsTabVisible(tsBk, true);
        riElec:
            IsTabVisible(tsElec, true);
        riBuckle:
            pnlBuckle.Visible := True;
        riIMSLimit:
            begin
                IsTabVisible(tsIMS, true);
        ...
        riAntipinch:
            IsTabVisible(tsAP, true);
        riMnlSlide:
            begin
                IsTabVisible(tsMnl, true);
                pnlMnlSlide.Visible := true;
            end;
        riMnlHeight:
            begin
                IsTabVisible(tsMnl, true);
                pnlMnlHeight.Visible := true;
            end;
    end;
end;
...
begin
    inherited;
    grbPump_Limit.Visible := TCheckBox(Sender).Checked;
...
begin
    inherited;
    grbSli_Limit.Visible := TCheckBox(Sender).Checked;
