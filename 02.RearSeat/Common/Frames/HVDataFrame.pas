...
uses
    ...
    Dialogs, LedArray, ExtCtrls, StdCtrls, Label3D, TransparentPanel, TeEngine, Series, TeeProcs, Chart,
    TimeChecker, HVTester;
...
begin
    ...
    chtAD.BoundsRect := Rect(pnlCurr.Left, pnlCurr.Top,
        lblOffLedDec.Left + lblOffLedDec.Width, pnlCurr.Top + pnlCurr.Height + Label3D4.Height + lblOffLedDec.Height);
end;
