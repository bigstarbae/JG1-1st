...
type
    ...
    public
        ...
        function GetBurnishingEnv(Motor: TMotorORD): TBrnEnv;
...
function TMtrComEnv.GetBurnishingEnv(Motor: TMotorORD): TBrnEnv;
begin
    Result := rBurnishing[ord(Motor)];
end;
...
begin
    ...
    if FileExists(GetHomeDirectory + DIR_ENV + '\Reference.Ini') then
    begin
