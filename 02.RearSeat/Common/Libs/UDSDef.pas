...
--------------------------------------------------------
    ...
    // 2세대 CAN
    _1ST_UDS_MSG_2GEN_TARGET_PSM_ID = $706;  //BCM -> PSM 으로 전송하는 ID
    _1ST_UDS_MSG_2GEN_RESP_PSM_ID = $726;  //응답 ID.
    ...
    // 3세대 CAN
    _1ST_UDS_MSG_3GEN_TARGET_PSM_ID = $7A3;  //BCM -> PSM 으로 전송하는 ID
    _1ST_UDS_MSG_3GEN_RESP_PSM_ID = $7AB;  //응답 ID.

    _1ST_UDS_MSG_3GEN_TARGET_APSM_ID = $797;  //BCM -> PSM 으로 전송하는 ID
    _1ST_UDS_MSG_3GEN_RESP_APSM_ID = $79F;  //응답 ID.
    ...
    _UDS_RDBI_2GEN_DID_DRV = $B4;         // 1열: LHD:$B4,  RH:$B7     2열: RL:$BA, RR:$BB
    _UDS_RDBI_2GEN_DID_PSG = $B7;
    _UDS_RDBI_2GEN_DID_RL = $BA;          // 2열
    _UDS_RDBI_2GEN_DID_RR = $BB;

    _UDS_RDBI_3GEN_DID = $B1;           // 3세대 통합.
    ...
    //-------------------------------------
    // Easy Access / 이그니션 관련  (FD 통합 CAN 이전 명령)
