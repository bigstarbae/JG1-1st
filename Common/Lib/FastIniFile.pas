...
2.91  2022/02/22
                 - 대괄호 허용: []
                 - WriteString시 신규 Ident 저장 안하는 Bug(?) 수정
*******************************************************************************}
unit FastIniFile;
...
{ TIniItems class }
  ...
  private
    ...
    FIsNewItem: boolean;                        // 2022.02.22 by E.S
...
begin
  ...
  begin
	...
	if (S[1] = '[') and (S[Length(S)] = ']') and (Pos('=', S) < 1) then		// 내용에 대괄호 허용[]  2022.02.22 by E.S
    begin
...
begin
  ...
  begin
    ...
    S := P.FValueStr;
    FModified := FIniItems.FIsNewItem;
