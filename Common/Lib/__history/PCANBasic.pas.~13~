...
{$Z1}
    ...
    TPCANMessageType = (
        ...
        PCAN_MESSAGE_FD_BRS     = $0C,
        /// <summary>
        /// The PCAN message represents a FD Extended frame (29-bit identifier) in terms of CiA Specs
        /// </summary>
        PCAN_MESSAGE_FDEXTENDED  = $06,
        /// <summary>
        ...
        /// </summary>
        PCAN_MESSAGE_FDEXTENDED_BRS = $0E,
		PCAN_MESSAGE_ESI       = $10,
        /// <summary>
