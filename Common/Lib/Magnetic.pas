...
Type
  ...
  TSubClass_Proc = function(lng_hWnd: Integer; uMsg: Integer;
  ...
  TMagnetic = class
   ...
   public
    function  AddWindow(Handle: Integer; hWndParent: Integer; var FuncPointer : TSubClass_Proc): Boolean;
    procedure CloseWindows;
    function  RemoveWindow(Handle: Integer): Boolean;
...
function TMagnetic.AddWindow(Handle: Integer; hWndParent: Integer; var FuncPointer : TSubClass_Proc): Boolean;
Var
  lC : Integer;
...
function TMagnetic.RemoveWindow(Handle: Integer): Boolean;
Var
  lc1 : Integer;
  lc2 : Integer;
...
procedure TMagnetic.CloseWindows;
var
    i: integer;
begin
    for i := 1 To m_lWndCount do
    begin
        if (m_uWndInfo[i].hWndParent = 0) then
            continue;
        self.RemoveWindow(m_uWndInfo[i].h_wnd);
        PostMessage(m_uWndInfo[i].h_wnd, WM_CLOSE, 0, 0);
    end;
end;
