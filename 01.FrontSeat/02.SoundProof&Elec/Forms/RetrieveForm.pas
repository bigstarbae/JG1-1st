...
begin
    ...
    begin
		...
		AddHeader([
			'백 프레임 각도, #L,      #L,        #L,        #L,         #L',
			'전방,           #L,      후방,      #L,        납품,       #L',
            '검사 기준,      각도,    검사 기준, 각도,      검사 기준,  각도'
		]);

        AddHeader([
            'RECL,        #L,      #L,          #L,      #L,          #L,      #L,      #L,          #L,      #L,     #L,           #L,      #L,    #L,         #L,         #L,     #L',
            '속도 검사,   #L,      #L,          #L,      초기 소음,   #L,      #L,      작동 소음,   #L,      #L,     전류,         #L,      #L,    전압,       #L,         #L,     #L',
            '검사 기준,   전진,    검사 기준,   후진,    검사 기준,   전진,    후진,    검사 기준,   전진,    후진,   검사 기준,    전진,    후진,  전진 최소,  전진 최대,  후진 최소,  후진 최대'
        ]);


        AddHeader([
            'L/SUPT,      #L,        #L,          #L,      #L,          #L,     #L,     #L',
            '초기 소음,   #L,       작동 소음,   #L,      전류,         #L,     전압,   #L',
            '검사 기준,   전진,     검사 기준,   전진,    검사 기준,    전진,   전진 최소,  전진 최대'
        ]);

        AddHeader([
            'BOLSTER,     #L,       #L,          #L,      #L,           #L,     #L,     #L',
            '초기 소음,   #L,       작동 소음,   #L,      전류,         #L,     전압,   #L',
            '검사 기준,   전진,     검사 기준,   전진,    검사 기준,    전진,   전진 최소, 전진 최대'
        ]);
...
begin
    ...
    MakeDataCtrlOrdFromDataGridOrd(DataCtrlORD,
        [rospecFwSpeedHiLo, rospecFwSpeedHiLo, rospecFwSpeedHiLo, rospecFwSpeedHiLo, rospecFwSpeedHiLo, rospecHeatOnHiLo, rospecHeatOnHiLo],
