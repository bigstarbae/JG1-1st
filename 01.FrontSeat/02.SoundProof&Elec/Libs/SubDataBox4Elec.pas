        ...
        case AORD of
            ...
            roRsVentByPos:
                begin
                    ...
                    Result := mParent.GetCompoJudge([roRsOnCurr, roRsOffCurr, roRsLedOff, roRsLedHi, roRsLedMid, roRsLedLo, roRsFlowTest]);
                end;
            ...
            roRsEcuPartNo, roDataEcuPartNo:
                begin
                    Result := rValidity[tsECUPartNo];
                end;

            roRsEcuHwVer, roDataEcuHwVer:
                begin
                    Result := rValidity[tsECUHWVer];
                end;

            roRsECUSWVer, roDataEcuSwVer:
                begin
            ...
            roRsElec:
                begin
                    Result := mParent.GetCompoJudge([roRsECUPartNo,
                                                     roRsECUHWVer,
                                                     roRsECUSWVer,
                                                     roRsAncPT,
                                                     roRsBuckle,
