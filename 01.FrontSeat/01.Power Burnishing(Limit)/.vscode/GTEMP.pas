...
begin
    ...
    mDIO.SetIO(DO_CAN_500K, not mCUrModelType.IsHI);
...
function TTsWork.FSMChaeckSpec: Integer;
begin
        ...
        _WS_DELETE_LIMIT:
            begin
                case mMtrSlide.FSMDeleteLimit(0) of
                    -1:
                        begin
                            SetError('리미트 삭제 실패', '전극 및 CAN 연결을 확인해 주세요');
...
begin
{$IFDEF _USE_PWS_CURR}
    Result := gDcPower.Items[0].GetMeasCurr;
    Exit;
