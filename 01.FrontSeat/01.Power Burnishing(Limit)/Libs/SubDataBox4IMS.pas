...
begin
    ...
    begin
        case APos of
                ord(roRsMem1), ord(roRsMem2), ord(roRsEasyAccess),
                ord(roRsIMS), ord(roRsLimit), ord(roRsTotLimit):
                begin
...
begin
    ...
    begin
        case AORD of
            ...
            roRsLimit:
                begin
                    rExists[tsLimit] := true;
                    rExists[tsTotLimit] := true;
                    rDatMtrs[rCurMtr].rLimit := Value;
                end;
        else
            mIsProcessDone := false;
