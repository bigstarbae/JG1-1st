...
begin
    ...
    begin
        ...
        case AORD of
            roDatOnCurr:
                begin
                    rModel.rSpecs.rOnCurr[rCurHVTestType].IsIn(GetData(AORD));
                end;
            ...
            roDatOffCurr:
                begin
                    rModel.rSpecs.rOffCurr[rCurHVTestType].IsIn(GetData(AORD));
                end;
            ...
            roRsElec:
                begin
                    Result := mParent.GetCompoJudge([roRsHeat, roRsVent, roRsBuckle, roRsODS, roRsAncPT, roRsEcuInfo, roRsDTCClear]);
                end;
...
{$ENDIF}
            ...
            ord(roRsElec), ord(roRsOnCurr), ord(roRsOffCurr), ord(roRsLedOff), ord(roRsLedHi), ord(roRsLedMid), ord(roRsLedLo), ord(roRsIgn), ord(roRsHeatByPos), ord(roRsVentByPos), ord(roRsHeat), ord(roRsVent), ord(roRsAccessory), ord(roRsSmart), ord(roRsODS), ord(roRsAncPT), Ord(roRsDTCClear), ord(roRsOnBlow), ord(roRsBuckle):
                begin
                    if not IsExists(TResultOrd(APos)) and not IsTested(TResultOrd(APos)) then
                        Exit;
...
begin
    ...
    begin
        ...
        case AORD of
            ...
            roDataEcuPartNo, roRsEcuPartNo, roDataEcuHwVer, roRsEcuHwVer, roDataEcuSwVer, roRsEcuSwVer, roRsEcuInfo:
        ...
        case AORD of
            ...
            roDataEcuHwVer:
                begin
                    ...
                    rExists[tsEcuInfo] := True;      // 추가
                    rTested[tsEcuInfo] := True;      // 추가
                end;
